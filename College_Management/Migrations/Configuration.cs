namespace College_Management.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<College_Management.DAL.CollegeContext>
    {
        ...
        protected override void Seed(College_Management.DAL.CollegeContext context)
        {
            ...
            //{
            //    new Teacher{  Name="Joe", Birthday=DateTime.Parse("1968-11-01"), Salary=1200 },
            //    new Teacher{  Name="Lisa", Birthday=DateTime.Parse("1968-10-01"), Salary=900 },
            //    new Teacher{  Name="Brad", Birthday=DateTime.Parse("1968-09-01"), Salary=1120 },
            //    new Teacher{  Name="Michael", Birthday=DateTime.Parse("1968-08-01"), Salary=870 },
            //    new Teacher{  Name="Alison", Birthday=DateTime.Parse("1968-07-01"), Salary=1300 },
            //    new Teacher{  Name="Victoria", Birthday=DateTime.Parse("1968-06-01"), Salary=1000 },
            //    new Teacher{  Name="Nate", Birthday=DateTime.Parse("1968-05-01"), Salary=1350 },
            //    new Teacher{  Name="Johnny", Birthday=DateTime.Parse("1968-04-01"), Salary=1050 },
            //};
            ...
            //{
            //    new Subject{SubjectId=1001, TeacherId=1, CourseId=1050,Title="Chemisty In Depth"},
            //    new Subject{SubjectId=1002,TeacherId=1,CourseId=1050,Title="Chemisty For Fun"},
            //    new Subject{SubjectId=1003,TeacherId=2, CourseId=4022,Title="EconomicsA"},
            //    new Subject{SubjectId=1004,TeacherId=3,CourseId=4041,Title="MacroEcA"},
            //    new Subject{SubjectId=1005,TeacherId=4,CourseId=1045,Title="Advanced Statistics"},
            //    new Subject{SubjectId=1006,TeacherId=4,CourseId=3141,Title="Basics References"},
            //    new Subject{SubjectId=1007,TeacherId=5,CourseId=2021,Title="Composing 101"},
            //    new Subject{SubjectId=1008,TeacherId=6,CourseId=2042,Title="Modern French Writing"},
            //};
